...
module.exports = class FakeNitro {
    ...
    honorBadge(){
        ...
        Patcher.after(this.meta.name, UserProfileStore, "getUserProfile", (_, args, ret) => {
            ...
            // if list of users that should have nitro_user badge includes current user,
            // and they don't already have the badge applied,
            // and the user badge isn't disabled,
            if(badgeUserIDs.includes(ret.userId) && !badgesList.includes("nitro_user") && !settings.disableUserBadge){
                //add the nitro user badge to the user's list of badges.
                ret.badges.push({
                    id: "nitro_user",
